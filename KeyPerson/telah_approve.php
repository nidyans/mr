    ...
    <div class="span12">
     <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Daftar Risiko Telah Diapprove</h5>
          </div>
      ...
      <th>Rata-Rata SP</th>
              ...
              <tbody>
                  <?php
                    ...
                    $sql = mysql_query("SELECT * FROM risiko WHERE status='1' AND YEAR(tgl_identifikasi)='$year' and kodeunit='$kodeunit'");
                    $no = 1;
      ...
      <th>Rata-Rata SP</th>
              ...
              <tbody>
                  <?php
                    ...
                    $sql = mysql_query("SELECT * FROM risiko WHERE status='1' AND status2='1' or status='1' AND status2='0'  AND YEAR(tgl_identifikasi)='$year' and rayon='$row_user[rayon]'");
                    $no = 1;
                    while ($r = mysql_fetch_array($sql)) {
               $nilai_lh=$r["likelihood"];
               $nilai_ks=$r["konsekuensi"];
