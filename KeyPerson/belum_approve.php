    ...
    <div class="span12">
     <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>DAftar Risiko Belum Diapprove</h5>
          </div>
      ...
      <th>Rata-Rata SP</th>
              ...
              <tbody>
                  <?php
                    ...
                    $sql = mysql_query("SELECT * FROM risiko WHERE status='0' AND status2='0' AND YEAR(tgl_identifikasi)='$year' and kodeunit='$kodeunit'");
                    $no = 1;
