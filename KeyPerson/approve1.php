...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
        	<form action="proses_approve1.php" name="approve" enctype="multipart/form-data" method="post">
	            ...
	            <div class="modal-footer">
	                ...
	                <button type="reset" class="btn btn-danger" data-dismiss="modal" aria-hidden="true" name="approve">
	               		Cancel
	                </button>
	            </div>
