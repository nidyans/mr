...
<?php
                    ...
                    $sql = mysql_query("select * from sasaran WHERE unit='$kodeunit'");
                    $no = 1;
...
<div class="row-fluid">
                <div class="span12 btn-icon-pg">
                  <ul>
                  <?php 
                  echo "<li><a href='?halaman=sasaran&&tahun=$year'><i class='icon-arrow-left'></i>Kembali</a></li>"; ?>
                  </ul>
                  </div></div>
        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" data-date-format="yyyy-mm-dd" name="tahun_sasaran" value="<?php echo $r['tahun_sasaran'] ?>" class="tanggal" readonly>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea type="text" class="span5" name="sasaran1" id="required" disabled=""><?php echo $r['sasaran1']; ?></textarea>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea type="text" class="span5" name="sasaran2" id="required" disabled=""><?php echo $r['sasaran2']; ?></textarea>
                <input type="hidden" name="id" value="<?php echo $id ?>"/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <textarea type="text" class="span5" name="sasaran3" id="required" disabled=""><?php echo $r['sasaran3']; ?></textarea>
                <input type="hidden" name="id" value="<?php echo $id ?>"/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <textarea type="text" class="span5" name="sasaran4" id="required" disabled=""><?php echo $r['sasaran4']; ?></textarea>
                <input type="hidden" name="id" value="<?php echo $id ?>"/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <textarea type="text" class="span5" name="sasaran5" id="required" disabled=""><?php echo $r['sasaran5']; ?></textarea>
                <input type="hidden" name="id" value="<?php echo $id ?>"/>
              </div>
            </div>
          </form>
