...
$sql_mitigasi =mysql_query("UPDATE  mitigasi SET likelihood ='$likelihood',persen ='$persen',konsekuensi='$konsekuensi',dampak_rp='$dampak_rp' WHERE id_risiko='$id_risiko'"); 
...
if($sql_mitigasi AND $sql){
  ...
  header("location:?halaman=evaluasi");
...
?>
 <div class="row-fluid">
                <div class="span12 btn-icon-pg">
                  <ul>
                  <?php 
                  echo "<li><a href='?halaman=evaluasi&&tahun=$tahun'><i class='icon-arrow-left'></i>Kembali</a></li>"; ?>
                  </ul>
                  </div></div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            ?>
              ...
              <div class="controls">
              <?php
           $unit="SELECT * from risiko where nrk='$namauser' and YEAR(tgl_identifikasi)='$tahun'";
      ...
      <th>Aksi</th>
               ...
               $level_risiko_re=$r['likelihood']*$r['konsekuensi'];
                 ...
                 <td class='center'><a href=?halaman=detail_risiko&&id=$r[id_risiko]>$row_risk[nama]</a></td>
                  ...
                  echo "<td class='center'>$r[likelihood]</td>
                        ...
                        <td class='taskOptions'><a href='?halaman=evaluasi&&mode=edit&&id=$r[id_risiko]&&tahun=$tahun' class='tip-top' data-original-title='Update'><i class='icon-ok'></i></a> 
                        </td>
                  </tr>";
                      $no++;
                    }                    
         ...
         case "edit":
            ...
            $row_rayon=mysql_fetch_array($sql_rayon);
             ...
             $skor= (($data["persen"]/100)*$data["rp_dampak"]);
             $uang = ($data2['dampak_rp']*($data2['persen']/100));
              $selisih= $skor-$uang; 
          ...
          <form class="form-horizontal">
           ...
           <div class="control-group">
              ...
              <div class="controls">
                  ...
                  <input type="text"  class="span1" disabled="" value="<?php echo $data['rp_pengendalian']; ?>" />
              </div></div>
              
              <div class="control-group">
              <label class="control-label">Ratio Cost dan Benefit</label>
              <?php if($data['rp_pengendalian']==0){
                  $bagi = 0;  }else{
                  $bagi=($selisih/$data['rp_pengendalian'])*100;} ?>
              <div class="controls">
...
<?php
        ...
        header("location: modul.php?halaman=evaluasi");
...
<div class="container-fluid">
 <form action="?halaman=evaluasi" method="post">
<body>
<table>
  <tr>
