...
<div class="row-fluid">
                <div class="span12 btn-icon-pg">
                  <ul>
                  <?php 
                  echo "<li><a href='?halaman=kejadian_risiko&&tahun=$tahun'><i class='icon-arrow-left'></i>Kembali</a></li>"; ?>
                  </ul>
                  </div></div>
<div class="row-fluid">
    ...
    <div class="span6">
        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               Rp <input type="text"  class="span4 m-wrap" disabled=""  value="<?php echo $r['akibat_rp']; ?>" />
                </br>
                </br>
              </div>
            </div>
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                 <textarea cols="40" disabled=""><?php echo $r['kejadian']; ?></textarea>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <textarea cols="40" disabled=""><?php echo $r['tindakan']; ?></textarea>
              </div>
            </div>
            ...
            <div class="control-group">  
              ...
              <div class="controls">
                <textarea cols="40" disabled="" ><?php echo $r['akibat']; ?></textarea>
              </div>
            </div>
             ...
             <div class="control-group">
              <label class="control-label">Langkah/Action</label>
              <div class="controls">
               <textarea cols="40" disabled=""><?php echo $r['langkah_action']; ?></textarea>
              </div>
            </div>
      ...
      <div class="widget-box">
            ...
            <ul class="quick-actions">
              ...
              <?php echo "<li class='bg_lb'> <a href='../filescan/$r[nama_file]'> <i class='icon-download'></i>Download File </a> </li>"; ?>
            </ul>
