...
<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
          ...
          <div class="widget-content nopadding">
            ...
            $row_unit=mysql_fetch_array($sql_unit);
             ...
             $level_risiko=$nilai_lh*$nilai_ks;
             $level_risiko_mit1=$nilai_lh_mit1*$nilai_ks_mit1;
              ...
              echo "<td class='center'>$query_mit1[likelihood]</td>
                 <td class='center'>$query_mit1[konsekuensi]</td>";
                  if ($level_risiko_mit1 >= 1 && $level_risiko_mit1<= 4){
                  echo "<td bgcolor='#00FF00' class='center'>$level_risiko_mit1</td>"; }
                  else if ($level_risiko_mit1 > 4 && $level_risiko_mit1<= 9){
                  echo "<td bgcolor='#FFCC00' class='center'>$level_risiko</td>";}
                  else if ($level_risiko_mit1 > 9 && $level_risiko_mit1 <= 16){
                  echo "<td bgcolor='#FFFF00' class='center'>$level_risiko_mit1</td>";
                  }else {
                    echo "<td bgcolor='#FF0000' class='center'>$level_risiko_mit1</td>";
                  }
...
<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
          ...
          <div class="widget-content nopadding">
            ...
            $row_unit=mysql_fetch_array($sql_unit);
             ...
             $level_risiko=$nilai_lh*$nilai_ks;
             $level_risiko_risk=$nilai_lh_risk*$nilai_ks_risk;
              ...
              echo "<td class='center'>$r[likelihood]</td>
                 <td class='center'>$r[konsekuensi]</td>";
                  if ($level_risiko_risk >= 1 && $level_risiko_risk<= 4){
                  echo "<td bgcolor='#00FF00' class='center'>$level_risiko_risk</td>"; }
                  else if ($level_risiko_risk > 4 && $level_risiko_risk<= 9){
                  echo "<td bgcolor='#FFCC00' class='center'>$level_risiko_risk</td>";}
                  else if ($level_risiko_risk > 9 && $level_risiko_risk<= 16){
                  echo "<td bgcolor='#FFFF00' class='center'>$level_risiko_risk</td>";
                  }else {
                    echo "<td bgcolor='#FF0000' class='center'>$level_risiko_risk</td>";
                  }
