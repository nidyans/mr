...
$sql = "SELECT count(*) AS jumlah FROM risiko where status = '1' and status2= '0' and YEAR(tgl_identifikasi)='$year' ";
...
$sql = "SELECT count(*) AS jumlah FROM risiko where kefektifan2 != '0' and status='1' and status2='1' and YEAR(tgl_identifikasi)='$year'";
$query = mysql_query($sql);
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Master Data</span> <span class="label label-important">6</span></a>
      <ul>
        <li><a href="?halaman=dt_nama_risiko" >Data Nama Risiko</a></li>
        <li><a href="?halaman=datauser" >Data User</a></li>
        <li><a href="?halaman=data_sbu" >Data SBU</a></li>
         <li><a href="?halaman=unitkerja" >Data Unit Kerja</a></li>
          <li><a href="?halaman=rayon" >Data Rayon</a></li>
        <li><a href="?halaman=data_periode" >Data Periode</a></li>
        <li><a href="?halaman=data_likon" >Data Range Likelihood/Konsekuensi</a></li>
      </ul>
    </li>
    <li> <a href="?halaman=data_berita"><i class="icon icon-info-sign"></i> <span>Berita</span> <span class="label label-important"></span></a></li>
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i><span>Rekap Risiko</span> <span class="label label-important">4</span></a>
      <ul>
        ...
        <li><a href="?halaman=rekap_sbu" >Rekap Risiko SBU</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i><span>Efektifitas Risiko</span></a>
      <ul>
        <li><a href="?halaman=sudah_dinilai" ><span class="label label-important"><h5><?php echo $yes_efektif['jumlah'];?></h5></span>Risiko Sudah Di Nilai</a></li>
...
<div id="content">
  ...
  <div class="container-fluid">
     <?php
                        if (isset($halaman)){
                            if ($halaman == "home"){
                                require_once("kananAdmin.php");                            
                            } elseif ($halaman == 'datauser') {
                                require_once("Datauser.php");
                             } elseif ($halaman == 'dt_nama_risiko') {
                                require_once("Data_nm_risiko.php");
                                } elseif ($halaman == 'unitkerja') {
                                require_once("unitkerja.php");
                                } elseif ($halaman == 'data_sbu') {
                                require_once("datasbu.php");
                                 } elseif ($halaman == 'rayon') {
                                require_once("datarayon.php");
                                } elseif ($halaman == 'data_periode') {
                                require_once("data_periode.php");
                              ...
                              require_once ("data_berita.php"); 
                              }elseif ($halaman == 'efektifitas') {
                              require_once ("dataTables/efektifitas.php");  
