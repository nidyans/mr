    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Informasi Pemilik Risiko</h5>
        </div>

        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Tanggal Identifikasi Risiko:</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo $r['tgl_identifikasi']; ?>" disabled="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Pejabat/Jabatan :</label>
              <div class="controls">
                <input type="text" class="span11"  disabled="" value="<?php echo $row_user['nama_pejabat']."/".$row_user['risk_owner'] ?>" />
              </div>
            </div>
            <div class="control-group">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span9" disabled="" value="<?php echo $r['pengendalian']; ?>">
               </div>
            </div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span5" disabled=""  value="<?php echo $r['kategori']; ?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Faktor Risiko :</label>
              <div class="controls">
                <input type="text" class="span5" disabled=""  value="<?php echo $r['faktor']; ?>"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Kelompok Risiko :</label>
              <div class="controls">
                <input type="text" class="span5" disabled=""  value="<?php echo $r['kelompok']; ?>"/>
              </div>
            </div>
          <div class="control-group">
              <label class="control-label">Nama Risiko</label>
              <div class="controls">
                 <textarea cols="100" rows="10" class="span5" disabled=""><?php echo $r['nama']; ?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">peristiwa Risiko</label>
              <div class="controls">
                 <textarea cols="100" rows="10" class="span5" disabled=""><?php echo $r['peristiwa']; ?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Sebab Risiko</label>
              <div class="controls">
                 <textarea cols="100" rows="10" class="span5" disabled=""><?php echo $r['sebab']; ?></textarea>
              </div>
            </div>
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
               <textarea cols="100" rows="10" class="span5" disabled=""><?php echo $r['dampak']; ?></textarea>
              </div>
            </div>
            <div class="control-group">
