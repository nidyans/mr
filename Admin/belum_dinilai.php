    ...
    <div class="span12">
     <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Daftar Risiko yang Belum dinilai</h5>
          </div>
      ...
      <th>Rata-Rata SP</th>
              ...
              <tbody>
                  <?php
                    ...
                    $sql = mysql_query("SELECT * FROM risiko WHERE kefektifan2 = '0' and status='1' and status2='1' and YEAR(tgl_identifikasi)='$year'");
                    $no = 1;
            ...
            $row_mit=mysql_fetch_array($sql_mit);
             ...
             $nilai_lh1=$row_mit["likelihood"];
               ...
               $level_risiko_mit=$nilai_lh1*$nilai_ks1;
