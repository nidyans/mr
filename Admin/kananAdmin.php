          ...
          <div class="widget-content">
            <div class="todo">
              ...
              <?php
                  ...
                  <div class='txt'>$r[berita] </div>
                  <div class='pull-right'> <a class='tip' href='modul.php?halaman=data_berita&&mode=edit&&id=$r[id]' title='Edit Task'><i class='icon-pencil'></i></a> <a class='tip' href='modul.php?halaman=data_berita&&mode=hapus' title='Delete'><i class='icon-remove'></i></a> </div>
                </li>";
                      $no++;
                    }                    
                    ?>
